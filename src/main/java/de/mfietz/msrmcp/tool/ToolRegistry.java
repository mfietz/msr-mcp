...
/**
 * Builds all {@link McpServerFeatures.SyncToolSpecification} instances for registration on the MCP
 * server builder via {@code .tools(list)}.
 */
public final class ToolRegistry {
    ...
    public static List<McpServerFeatures.SyncToolSpecification> buildSpecs(
        ...
        return List.of(
                ...
                new McpServerFeatures.SyncToolSpecification(
                        GetChurnTool.toolSpec(), (exchange, req) -> churn.handle(req.arguments())),
                new McpServerFeatures.SyncToolSpecification(
