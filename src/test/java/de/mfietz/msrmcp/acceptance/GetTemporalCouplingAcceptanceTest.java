 ...
 *
 * <p>Test repo: A.java and B.java are always changed together (3 commits). C.java appears alone in
 * one of those commits. Expected: A↔B has the highest coupling ratio (1.0).
 */
...
class GetTemporalCouplingAcceptanceTest {
    ...
    void withSinceFilter_dynamicQueryIsUsed() {
        ...
        CallToolResult result =
                couplingTool.handle(Map.of("topN", 5, "minCoupling", 0.1, "sinceEpochMs", 0));
